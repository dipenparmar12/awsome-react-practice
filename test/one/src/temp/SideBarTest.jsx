...
export default function SideBarTest() {
  return (
    <>
      ...
      <div className="flex-col w-full bg-gray-100 md:flex md:flex-row md:min-h-screen">
        <div className="flex flex-col flex-shrink-0 w-full text-gray-700 bg-white md:w-48 dark-mode:text-gray-200 dark-mode:bg-gray-800 ">
